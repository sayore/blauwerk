...
const seeds: Record<ScenarioCategory, readonly ScenarioSeed[]> = {
  discovery: [
    ...
    ["planned", "Duplicate Classic and LE identities"],
  ...
  pairing: [
    ...
    ["planned", "Numeric confirmation required"],
    ["planned", "Passkey must be entered on host"],
    ["planned", "Passkey must be typed on device"],
  ...
  connection: [
    ...
    ["planned", "Another Bluetooth manager competes"],
  ...
  audio: [
    ...
    ["planned", "A2DP transport Acquire fails"],
    ...
    ["planned", "Application stays on old sink"],
    ["planned", "Wrong default output"],
  ...
  host: [
    ...
    ["planned", "PulseAudio and PipeWire conflict"],
