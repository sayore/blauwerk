...
const seeds: Record<ScenarioCategory, readonly ScenarioSeed[]> = {
  discovery: [
    ...
    ["handled", "Wrong default adapter"],
    ["handled", "Adapter lacks BR/EDR or LE"],
    ...
    ["handled", "2.4 GHz / USB 3 interference"],
    ["partial", "Device changes identity after factory reset"],
    ["handled", "Device already connected to another host"],
  ...
  pairing: [
    ...
    ["handled", "CTKD / dual-bearer key mismatch"],
  ...
  audio: [
    ...
    ["handled", "High-quality codec is unstable"],
    ["handled", "LE Audio device lacks BAP support"],
    ["handled", "Headset supports music but no microphone"],
    ["handled", "HFP/HSP backend missing"],
  ...
  input: [
    ...
    ["handled", "Battery level unavailable"],
